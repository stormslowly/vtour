/* krpano 1.17.pr2 gyro plugin (build 2014-01-10)
...
var krpanoplugin = function() {
  ...
  function C() {
    k && l && (window.removeEventListener("deviceorientation", J, !0), c.control._linklist.append(list, item);yer.removeEventListener("touchstart", K), c.control.layer.removeEventListener("touchend", A), c.control.layer.removeEventListener("touchcancel", A));
  ...
  this.registerplugin = function(krpanointerface, pluginpath, pluginobject) {
    ...
    c = b;
    e = m;
    if ("%" != c.build.charAt(0) && ("1.0.8.14" > c.version || "2011-03-30" > c.build))
      c.trace(3, "gyro plugin - too old krpano version (min. 1.0.8.14)");
    else {
